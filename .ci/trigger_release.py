...
def parse_component_descriptor():
    descriptor_path = cdu.component_descriptor_path(ocm.SchemaVersion.V2)
...
def ocm_repository_lookup():
    ...
    traits = parsed['ocm-gear']['base_definition']['traits']
...
def main():
    ...
    logger.info('diffs were found since last released ocm-gear version')
